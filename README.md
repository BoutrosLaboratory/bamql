...
In order to compile, [LLVM](http://llvm.org/) 5.0 - 8, [HTSlib](https://github.com/samtools/htslib/), and libuuid are required. If compiling using GCC, version 4.9 or later is required.
